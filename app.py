    ...
    if datos_usuario_sel:
        ...
        if pin_ingresado == pin_correcto:
            ...
            **A todos los participantes, visionarios, escépticos y matemáticos del fútbol:**
            ...
            Considerando que: Mientras muchos sumaban números y analizaban estadísticas con la cabeza fría, un país entero jugaba con el corazón ardiendo. Celebramos más que tres puntos o una clasificación; celebramos el triunfo sobre lo imposible.
